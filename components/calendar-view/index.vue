<template>
    <div class="w-full">
        ...
        <div class="relative border border-secondary rounded-lg overflow-hidden p-6">
            <h2 class="text absolute top-0 left-0 text-xl font-bold cursor-pointer flex flex-row w-full p-6" @click="showDateSelectModal">
                {{ calendarTitle }}
            </h2>
