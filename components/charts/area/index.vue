...
const options = {
  chart: {
    height: 350,
    type: "area",
    background: props.colorLightBlue
      ? "linear-gradient(180deg, rgba(4,55,92,0 ) 0.00%, rgba(63,192,255,0.72 ) 100.00%)"
      : "linear-gradient(180deg, rgba(4,55,92,0 ) 0.00%, #04375c 100.00%)",
    toolbar: {
      show: false,
    },
    events: {
