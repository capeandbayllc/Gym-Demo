<template>
  <div class="relative">
    <span class="absolute left-0 bg-[#0075C9] h-full px-4 rounded-tl-[19px] rounded-bl-[19px] flex items-center justify-center">
      <ArrowLeft class="rotate-0 left-0 text-white"/>
    </span>
