      ...
      <div class="flex flex-row gap-8">
        <div class="flex flex-col w-[calc(89%-1rem)]">
          ...
          <div class="flex flex-col gap-5">
            ...
            >
              ...
              <span class="w-[30%] my-auto flex flex-row gap-4 justify-end">
                <span
        ...
        <div class="w-[calc(11%-1rem)] flex flex-col justify-between">
          <div class="w-full pb-[100%] relative">
            ...
            >
              <PosAdminDashboardIcon class="relative w-[40%] h-auto mx-auto" />
              <span class="text-[0.6rem] mx-auto mt-1"> Dashboard </span>
            </button>
          </div>
          <div class="w-full pb-[100%] relative">
            <button
              class="absolute bg-[#191919]/[0.9] h-full w-full border rounded-lg top-0 left-0 flex flex-col justify-center"
            >
              <InventoryIcon class="relative w-[40%] h-auto mx-auto" />
              <span class="text-[0.6rem] mx-auto mt-1"> Inventory </span>
            </button>
          </div>
          <div class="w-full pb-[100%] relative">
            <button
              class="absolute bg-[#191919]/[0.9] h-full w-full border rounded-lg top-0 left-0 flex flex-col justify-center"
            >
              <SettingsAndConfigIcon class="relative w-[40%] h-auto mx-auto" />
          ...
          <div class="w-full pb-[100%] relative">
            ...
            >
              <DiscountIcon class="relative w-[40%] h-auto mx-auto" />
              <span class="text-[0.6rem] mx-auto mt-1"> Discounts </span>
            </button>
          </div>
        </div>
      </div>
