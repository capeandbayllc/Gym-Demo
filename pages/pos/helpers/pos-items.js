...
const itemsMeta = [
    ...
    {
        category: "Beverage",
        suppliers: ["Company", "Another Company", "Second Another Company", "Some Company"],
        subcategories: [
            {
                multiplier: Math.random(),
                title: "Water",
...
const getInventoryCategories = () => {
    ...
    itemsMeta.forEach(cat => {
        categories.push({ id: cat.category, title: cat.category, subcategories: cat.subcategories })
    });
