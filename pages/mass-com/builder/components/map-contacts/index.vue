  ...
  <div class="map-contacts-container">
      ...
      <div class="map-contacts-form">
        ...
        <div class="form-control w-full">
          ...
          <input
            id="folder_name"
            type="text"
            placeholder="Internal name (e.g. Journey #4 or Customer welcome flow)"
        ...
        <div class="form-control w-full mt-3">
          ...
          <input
            id="audience"
            type="text"
            placeholder="Gymrevenue Fitness"
            class="text-input-field"
          />
        </div>
        ...
        <div class="flex mt-6 justify-center">
          <Button
            ...
            @click.stop="$emit('next-page', 'lead-sources')"
          >
            Connect Leads
    ...
    <div class="flex mt-2">
      ...
      >
        ...
        <a
          class="text-xs ml-1"
          @click.stop="$emit('next-page', 'select-template')"
          >Back</a
        >
      </span>
    </div>
