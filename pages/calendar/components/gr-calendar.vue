  ...
  <div class="relative">
    ...
    >
      ...
      >
        ...
        <span class="my-auto line-clamp-1 text-[0.8rem]"> John Doe </span>
    ...
    <div class="absolute w-[18%] h-[50px] top-[10px] right-0 hidden lg:block">
      <div
...
onMounted(async () => {
  document.addEventListener("click", setShowCalendarUserDropDownToFalse, true);
  await nextTick();
