<template>
  ...
  >
    ...
    <div class="guests-wrap">
      ...
      <span><img class="w-10 pr-2" src="/account.png" /></span>
      <span><img class="w-10 pr-2" src="/account.png" /></span>
      <button class="ml-5" @click="addMember">
        <add-icon class="h-6 w-6 inline-block" />
      </button>
    </div>
    <div class="flex items-center">
    ...
    <div>
      ...
      >
        <div v-if="!isSearchOpen" class="w-full relative flex items-center">
          ...
          <input
            type="file"
            class="opacity-0 absolute w-full h-full top-0 left-0 z-20 cursor-pointer"
          />
        </div>
        ...
        <div
          class="w-[60px] text-center cursor-pointer"
