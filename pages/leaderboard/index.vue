  ...
  <div class="page-club-container">
    <div class="-md:px-4 page-content flex-col">
      ...
      <div class="flex flex-row my-4 mt-4">
        <select-box :items="statsFilter" label="States Filter" class="w-36" />
        <!-- <multiselect
          ...
          <carousel ref="membershipCarousel" :breakpoints="breakpoints">
            <slide v-for="(member, index) in membershipData" :key="index">
              <simple-card class="px-4 membership-simple-card">
                <span v-if="member.isFavourite" class="absolute top-0 right-2">
                  <star-icon />
                </span>
                <div class="flex items-center justify-center p-5">
                  ...
                  <div class="text-[12px] text-left">
                    <p>{{ member.name }}</p>
                    <p>
                      <span class="text-secondary">Club Location:</span>
                      {{ member.clubLocation }}
                    </p>
                  </div>
                </div>
                <div class="p-1 border border-base-content rounded flex mb-4">
                  <div class="text-center text-sm w-2/4">
                    <p class="text-secondary my-1">
                      Goal:
                      <span class="ml-1">{{ member.goalUnitSold }}</span>
                    </p>
                    <ClientOnly>
                      <apexchart
                        type="donut"
                  ...
                  <div class="text-center text-sm w-2/4">
                    <p class="text-secondary my-1">
                      Goal:
                      <span class="ml-1">{{ member.goalRevenue }}</span>
                    </p>
                    <ClientOnly>
                      <apexchart
                        type="donut"
