<template>
    <div class="page-engage-container">
        <div class="page-title">Engage</div>
        <div class="page-content">
            <tab-list v-model="activeTab"/>
            <div class="tab-view">
                <component :is="tabViews[activeTab]" v-if="activeTab > -1"/>
                <div class="w-64 h-56" v-else />
            </div>
        </div>
    </div>
</template>
...
import EmployeeTab from './components/employee-tab/index.vue'
...
const tabViews = [EmployeeTab, LeadTab, MemberTab, FitnessTab, FitnessTab, FitnessTab, FitnessTab]
</script>