<template>
  <div class="leads-list-container">
    <h3 class="flex justify-between">
      {{ tableSelected }} <search-input neutral size="md" border="neutral" />
    </h3>
    <div>
      <data-table
        :data="data"
    ...
    <Button
      secondary
      size="xs"
      class="view-btn float-right font-semibold mb-3 mt-2 mr-3"
    >
      <svg
...
<script setup>
import LeadsTableRow from "./leads-table-row.vue";
