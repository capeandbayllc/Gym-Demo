<template>
  <div class="data-graph-container pb-2 border-2 border-secondary rounded-[15px] h-full">
      <div class="flex items-center justify-between pt-2 px-4">
        <label class="header block text-xs whitespace-nowrap mr-2 text-base-content text-left">Data Graph Analysis</label>
        <Listbox as="div" v-model="selected">
          <div class="relative">
            <ListboxButton class="relative w-full cursor-default rounded-md bg-transparent border border-secondary py-0 px-2 text-left text-base-content shadow-sm focus:outline-none sm:text-sm ">
              ...
              <span class="pointer-events-none absolute inset-y-0 right-0 ml-3 flex items-center pr-2 text-base-content">
              </span>
            </ListboxButton>
