    ...
    <div class="circle-big">
        <div class="progress-bar">
          ...
          <svg class="prog relative">
            ...
            <circle class="progress" :stroke="item.color" cx="45" cy="45" r="37" :stroke-dashoffset="230.56/100*(-item.percent-100)"></circle>
          </svg>
        </div>
        <div class="gradient" :style="{backgroundImage: item.gradient}"></div>
      </div>
