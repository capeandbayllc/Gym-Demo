<template>
  <div class="lg:flex space-x-3">
    <simple-card title="Send an E-mail" class="rounded-xl">
      <div
        class="bg-gradient-to-t rounded-b-xl from-secondary-content to-secondary-focus p-6 w-[500px]"
      >
              ...
              <div class="text-center mb-2">
                <div>
                  <input
                    type="text"
                    placeholder="Subject"
                    class="w-full h-10 rounded-xl bg-transparent border-[1px] px-4 placeholder-white"
                  />
                </div>
                <div class="mt-2 relative">
                  <textarea
                    placeholder="Body"
                    class="w-full h-10 rounded-xl bg-transparent border-[1px] px-4 placeholder-white h-24"
                  ></textarea>
