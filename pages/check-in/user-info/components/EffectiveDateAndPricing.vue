<template>
  <div>
    <div
      class="bg-gradient-to-b from-secondary to-[#003255] rounded-t-[14px] text-center py-1"
    >
    ...
    <div
      class="bg-gradient-to-b from-secondary to-[#003255] rounded-b-[14px] text-center py-3"
    >
      <p class="font-light text-sm -mb-1">PROMO CODE</p>
      <p class="text-xl font-semibold">
        XMAS DAY <span class="ml-10">-$9.48</span>
      </p>
    </div>
  </div>
</template>
