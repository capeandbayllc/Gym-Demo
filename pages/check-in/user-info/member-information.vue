<template>
    <user-info-card>
        <Button class="text-white capitalize"
            :class="isActiveMember ? 'bg-slate-400 hover:bg-slate-500' : 'bg-lime-500 hover:bg-lime-600'"
        ...
        <Button secondary size="sm" class="place-self-end" @click="showAgreementPopUp">Create New Agreement</Button>

        <div v-for="item in memberInformation" :key="item.key" class="mem-info-item">
