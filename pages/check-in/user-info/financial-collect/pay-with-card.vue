<template>
  <div class="mb-4">
    <label class="text-sm mb-2 inline-block">Pay With Card</label>
    <img src="/checkin/cards-image.png" alt="" />
  </div>
  <div class="mb-4">
    <label class="text-sm mb-2 inline-block">Cardholder Name</label>
    <input
      class="gray-input w-full py-1 px-2 rounded-sm text-base-300"
  ...
  <div class="flex gap-4">
    ...
    <p class="text-sm">
      By checking this box, you agree to allow Fitness Connection to charge the
      credit card provided above in lieu of presenting it for in club purchases.
    </p>
  </div>
</template>
<script setup>
