<template>
    <div class="border border-secondary p-4 rounded-[20px] summury-wrap card-gradient-bg w-full">
        ...
        <div class="border border-secondary rounded-[14px] bg-base-300">
            ...
            <div class="bg-gradient-to-b from-secondary to-secondary-focus text-center py-1">
            ...
            <div class="bg-gradient-to-b from-secondary to-secondary-focus rounded-b-[14px] text-center py-3">
