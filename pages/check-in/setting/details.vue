<template>
  <div class="grid grid-cols-3 gap-x-6 w-full -md:grid-cols-1">
    <simple-card>
      <div class="detail-card card-gradient-bg">
    ...
    <simple-card>
      <div class="detail-card card-gradient-bg">
        ...
        <p class="mb-4 flex-1">
          ...
          <br /><br />
          Some of your recent sessions are listed below; however, this list may
          not be exhaustive. If you feel your account has been compromised, you
          should also update your password.
        </p>
        <Button secondary size="sm" class="mx-auto capitalize"
    ...
    <simple-card>
      <div class="detail-card card-gradient-bg">
        <h3>Delete Account <LockIcon class="inline-block" /></h3>
        <p class="mb-4 flex-1">
          Permanently delete your account. <br /><br />
