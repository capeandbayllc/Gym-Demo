<template>
  <setting-base-card>
    <div class="col-span-3 w-full py-4 px-10 mx-auto max-w-[600px]">
      ...
      <p class="text-center leading-10 text-sm mb-6">
      ...
      <div class="mx-auto w-full mb-4">
        ...
        <input
          ...
          v-model="updatePassword.currentPass"
        />
      </div>
      <div class="mx-auto w-full mb-4">
      ...
      <div class="mx-auto w-full mb-4">
        ...
        <input
          type="password"
          class="neutral-input w-full p-1 rounded-sm"
          v-model="updatePassword.confirmPass"
        />
      </div>
      <p
        v-if="updatePassword.newPass !== updatePassword.confirmPass"
        class="text-sm text-error mb-2"
      >
        New Password and Confirm password dose not matched!
      </p>
      <div class="col-span-3 mx-auto w-full text-center">
        ...
        <Button
          ...
          class="capitalize"
          :disabled="
            updatePassword.currentPass == '' ||
            updatePassword.newPass == '' ||
            updatePassword.confirmPass == '' ||
            updatePassword.newPass !== updatePassword.confirmPass
          "
          >Save</Button
        >
      </div>
