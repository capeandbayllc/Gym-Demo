<template>
  <div class="lg:flex space-x-3">
    <simple-card title="Send an E-mail" class="rounded-xl">
      ...
      >
        <div
          class="bg-base-300 p-4 border-[1px] border-info-content rounded-xl"
        >
          <Body
              ...
              <div class="text-center mb-2">
                <div>
                  <input
                    type="text"
                    placeholder="Subject"
                    class="w-full h-10 rounded-xl bg-transparent border-[1px] px-4 placeholder-base-content"
                  />
                </div>
                <div class="mt-2 relative">
                  <textarea
                    placeholder="Body"
                    class="w-full h-10 rounded-xl bg-transparent border-[1px] px-4 placeholder-base-content h-24"
                  ></textarea>
