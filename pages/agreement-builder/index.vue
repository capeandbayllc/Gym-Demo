...
<style>
    ...
    @media (max-width:980px){
        .new-agreement-card-content .title-text{font-size: 14px !important;width: auto !important;}
    ...
    @media (max-width:820px){
        ...
        .new-agreement-card-content .title-text{font-size: 12px !important;width: auto !important;}
