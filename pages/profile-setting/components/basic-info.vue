      ...
      <div class="grid grid-cols-12 gap-4 py-2 mt-4">
        ...
        >
          ...
          <div class="grid grid-cols-12 p-2 mb-5 -mt-3">
            <div class="col-start-2 col-span-10">
              <div
                class="grid grid-cols-2 lg:grid-cols-2 md:grid-cols-1 gap-4 lg:mb-0 md:mb-5"
              >
                <div class="mb-5 rounded-lg overflow-hidden">
                  <input
                    class="neutral-input ml-8"
              ...
              >
                <div class="mb-5 rounded-lg overflow-hidden">
                  <input
                    class="neutral-input ml-8"
                    v-model="form.social.snapchat"
                  />
                  <div class="w-9 h-9 mr-3 bg-blue-500 -mt-9">
                    <img
                      src="/social-icon/snapchat.png"
                      class="w-60 cursor-pointer"
                      alt="snapchat"
                    />
                  </div>
          ...
          <div class="grid grid-cols-12 pb-2 gap-4">
            <div class="col-span-4 w-full">
              <div class="multi-select-tags">
                <div
                  class="float-left h-9 bg-secondary rounded-xl px-1.5 mr-2 mt-2 cursor-pointer pt-2 w-max"
                  v-for="value in form.homeLocations"
                  :key="value"
                  @click="
                    removeOption(form.homeLocations, value, 'homeLocations')
                  "
                >
            ...
            <div class="col-span-4 w-full ml-0.5">
              <div class="multi-select-tags">
                <div
                  class="float-left h-9 bg-secondary rounded-xl px-1.5 mr-2 mt-2 cursor-pointer pt-2 w-max"
                  v-for="value in form.roles"
                  :key="value"
                  @click="removeOption(form.roles, value, 'roles')"
                >
            ...
            <div class="col-span-4 w-full ml-1.5">
              <div class="multi-select-tags">
                <div
                  class="float-left h-9 bg-secondary rounded-xl px-1.5 mr-2 mt-2 cursor-pointer pt-2 w-max"
                  v-for="value in form.departments"
                  :key="value"
                  @click="removeOption(form.departments, value, 'departments')"
                >
        ...
        <div class="grid grid-cols-12 pb-2">
          <div class="col-span-4 col-start-2 w-8/12">
            <div class="multi-select-tags">
              <div
                class="float-left h-9 bg-secondary rounded-xl px-1.5 mr-2 mt-2 cursor-pointer pt-2 w-max"
                v-for="value in form.teams"
                :key="value"
                @click="removeOption(form.teams, value, 'teams')"
              >
      ...
      <div class="grid grid-cols-1 py-2">
        <div class="grid grid-cols-12 py-2">
          <div class="col-start-2 col-span-3">
            ...
            <div class="grid grid-cols-1 ml-0">
              <div class="col-span-12">
                <div
                  class="float-left h-9 bg-secondary rounded-xl px-1.5 mr-2 mt-2 cursor-pointer pt-2 w-max"
                  v-for="value in form.calendarDepartments"
                  :key="value"
                  @click="
                    removeOption(
                      form.calendarDepartments,
                      value,
                      'calendarDepartments'
                    )
                  "
          ...
          <div class="col-start-6 col-span-6">
            <div
              class="border-2 border-secondary rounded-2xl p-12 pr-8 w-full mb-4 bg-transparent"
            >
            ...
            >
              <span class="text-base text-gray-500 hover:text-blue-400"
                >Cancel</span
              >
            </Button>
          </div>
      ...
      <div class="grid grid-cols-1 pt-2 pb-8">
        <div class="grid grid-cols-1 justify-items-center">
          <div class="text-center">
            ...
            >
              <span
                class="text-light text-gray-500 hover:text-blue-400"
