        ...
        <div class="page-content">
            ...
            <template v-for="section in sections" :key="section.key">
                <div
                    ...
                    :class="`col-span-${item.span ? item.span : 1} -lg:col-span-1 -md:col-auto`"
                >
                    <div>{{item.label}}</div>
            ...
            <div class="divider"></div>
            <div class="col-span-3 3xl:col-span-4 -lg:col-span-2 -md:col-span-1">
                <h4 class="mb-4 inline-block w-full">Notes</h4>
                <textarea name="notes" rows="6" class="neutral-input rounded w-full mb-4"></textarea>
                <div class="text-center">
                    <Button ghost size="sm" class="mr-2 capitalize">Cancel</Button>
