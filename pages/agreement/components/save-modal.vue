<template>
  <div
    class="gradient-bg rounded border border-secondary grid grid-cols-1 p-3 gap-4 w-[400px] text-sm max-h-[75vh] overflow-auto"
  >
    <div class="text-center text-xl font-semibold">Save</div>
    <div>
      <div class="mb-2">Agreement Name</div>
      <input
        type="text"
        v-model="agreementName"
        placeholder="Pre Populated Name"
        class="white-input w-full p-2 rounded"
      />
    </div>
  </div>
</template>
