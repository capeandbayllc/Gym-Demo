<template>
    <simple-card class="gradient-bg p-4 w-[750px] text-sm">
        <div class="mb-3 mx-auto w-full flex justify-between items-center bg-secondary rounded py-1 px-5">
            <div>
                <div class="font-semibold text-lg">Type Agreement</div>
                <div>Name</div>
            </div>
            <div class="text-center">
                <img src="/gym-revenue-base-content.png" class="h-6 inline-block">
            </div>
        </div>
...
onMounted(() => {
  if (props.newAgreementData.agreementType !== null) {
