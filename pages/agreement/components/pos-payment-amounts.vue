<template>
  <simple-card
    class="gradient-bg grid grid-cols-12 p-4 gap-x-4 gap-y-8 w-[700px] text-sm max-h-[75vh] overflow-auto"
  >
    ...
    <div class="col-span-3 w-full flex">
      <p
        class="pl-4"
        :class="{ 'text-neutral-content': !data.activeInitiationFee }"
      >
        1. Initialition Fee
      </p>
    </div>
    <div class="col-span-3 mx-auto w-full">
      <input
        :disabled="!data.activeInitiationFee"
        type="number"
        class="white-input w-full p-1 rounded-sm"
        v-model="data.initialitionFeePrice"
      />
    </div>
    <div class="col-span-3 mx-auto w-full">
      <input
        ...
        type="number"
        class="white-input w-full p-1 rounded-sm"
        v-model="data.initialitionFeePriceMaximum"
      />
      <input
        :disabled="!data.activeInitiationFee"
        type="number"
        class="white-input w-full p-1 rounded-sm mt-3"
        v-model="data.initialitionFeePriceMinimum"
      />
    </div>
    <div class="col-span-3 w-full flex justify-center">
      <div>
        <button
          v-if="data.activeInitiationFee"
          @click="buttonActiveInitiationFee.click()"
          class="pt-1"
        >
          Remove
        </button>
    ...
    <div class="col-span-3 w-full flex">
      <p
        class="pl-4"
        :class="{ 'text-neutral-content': !data.activeFirstMonthsDues }"
      >
        2. First Months Dues
      </p>
    </div>
    <div class="col-span-4 mx-auto w-full">
      <input
        :disabled="!data.activeFirstMonthsDues"
        value="Pro Rate Monthly PTM"
        class="white-input w-full p-1 rounded-sm"
      />
    </div>
    ...
    <div class="col-span-3 w-full flex justify-center">
      <div>
        <button
          v-if="data.activeFirstMonthsDues"
          @click="buttonActiveFirstMonthsDues.click()"
          class="pt-1"
        >
          Remove
        </button>
    ...
    <div class="col-span-3 w-full flex">
      <p
        class="pl-4"
        :class="{ 'text-neutral-content': !data.activeTotalAmountPaid }"
      >
        3. *Total Amount Paid Today
      </p>
    </div>
    ...
    <div class="col-span-3 w-full flex justify-center">
      <div>
        <button
          v-if="data.activeTotalAmountPaid"
          @click="buttonActiveTotalAmountPaid.click()"
          class="pt-1"
        >
          Remove
        </button>
    ...
    <div class="col-span-12 flex justify-center">
      <div class="flex items-center mt-3">
        <div class="flex items-center mx-2">
          <input
            type="checkbox"
            class="toggle toggle-info toggle-sm mr-2"
            ref="buttonActiveInitiationFee"
            v-model="data.activeInitiationFee"
          />Initiation Fee
        </div>
        <div class="flex items-center mx-2">
          <input
            type="checkbox"
            class="toggle toggle-info toggle-sm mr-2"
            ref="buttonActiveFirstMonthsDues"
            v-model="data.activeFirstMonthsDues"
          />First Months Dues
        </div>
        <div class="flex items-center mx-2">
          <input
            type="checkbox"
            class="toggle toggle-info toggle-sm mr-2"
            ref="buttonActiveTotalAmountPaid"
            v-model="data.activeTotalAmountPaid"
          />Last Months Dues
        </div>
      </div>
    </div>
