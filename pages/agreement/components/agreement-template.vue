<template>
  <simple-card
    class="gradient-bg grid grid-cols-2 p-4 gap-4 w-[650px] text-sm max-h-[75vh] overflow-auto"
  >
    <div class="col-span-1 -lg:col-span-2 -md:col-auto mx-auto w-full">
      <div class="mb-2 font-semibold text-lg">Agreement Template</div>
    </div>
    <div class="col-span-1 -lg:col-span-2 -md:col-auto mx-auto w-full">
      <div class="flex items-center mx-2 mt-1 float-right">
        <input
          type="checkbox"
    ...
    <div class="col-span-1 -lg:col-span-2 -md:col-auto mx-auto w-full">
      ...
      <select-box
        ...
        :label="
          data.promotionSegment == ''
            ? 'Select'
            : data.promotionSegment == 'yes'
            ? 'Yes'
            : 'No'
        "
        labelOpened="Limited Availability"
    ...
    <div class="col-span-1 -lg:col-span-2 -md:col-auto mx-auto w-full">
      ...
      <input
        class="white-input w-full p-1 rounded-sm"
        v-model="data.agreementTemplate"
      />
    </div>
    <div class="col-span-1 -lg:col-span-2 -md:col-auto mx-auto w-full">
      ...
      <select-box
        ...
        :label="
          data.availableForPresale == ''
            ? 'Select'
            : data.availableForPresale == 'yes'
            ? 'Yes'
            : 'No'
        "
        labelOpened="Limited Availability"
    ...
    <div class="col-span-1 -lg:col-span-2 -md:col-auto mx-auto w-full">
      ...
      <input
        class="white-input w-full p-1 rounded-sm"
        v-model="data.billingSystemType"
      />
    </div>
