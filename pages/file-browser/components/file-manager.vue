      ...
      <section class="col-span-6 overflow-hidden">
              ...
              <div class="mt-2 sm:mt-0 sm:col-span-2">
                ...
                >
                  <div class="relative z-20 text-center">
                    <upload-icon :active="uploadDragoverTracking" />
                    <p class="mt-4">Drag and Drop your Files here</p>
                    ...
                    <p class="mt-2 text-sm text-gray-600">
                      <label
                        ...
                        ><input
                          @input="
                            form.files = [...form.files, ...$event.target.files]
                          "
                          type="file"
                          multiple
                          hidden
        ...
        >
          ...
          >
            ...
            />
            <jet-label for="visibility" value="Make this upload public?" />
          </div>
          <div class="flex">
            <button
              type="button"
