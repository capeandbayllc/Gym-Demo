<template>
  <div class="subleased-area-container">
    <div class="flex items-center justify-between mb-6 h-full">
      <div
        class="relative h-full flex flex-col justify-center text-left text-base-content"
      >
              ...
              <SwitchGroup as="div" class="flex items-center">
                ...
                <SwitchLabel as="span" class="ml-3 text-sm">
                  <span
                    class="font-medium"
                    :class="
                      filters.type ? 'text-secondary' : 'text-neutral-content'
                    "
                    >Type</span
                  >
                </SwitchLabel>
              ...
              <SwitchGroup as="div" class="flex items-center">
                ...
                <SwitchLabel as="span" class="ml-3 text-sm">
                  <span
                    class="font-medium"
                    :class="
                      filters.alert ? 'text-secondary' : 'text-neutral-content'
                    "
                    >Alert</span
                  >
                </SwitchLabel>
    ...
    <div class="subleased-area-list">
      ...
      <div class="text-left mt-3">
        <label class="text-[14px] text-base-content"
          >Location Information</label
        >
        <div
          class="border-2 border-base-content rounded-xl text-base-content mt-4 p-4 text-[14px]"
        >
          <div class="flex items-center gap-2">
            <img
              class="rounded-lg h-20 w-20 object-cover bg-base-content/80"
              :src="clubItems.location_info.subleased_thumb"
              alt="{{ clubItems.location_info.club_number }}"
            />
          ...
          <div class="flex items-center mt-4">
            <img
              class="rounded-lg object-cover bg-base-content/80 w-full"
              :src="clubItems.location_info.map_img"
              alt="{{ clubItems.location_info.club_number }}"
            />
          </div>
        </div>
