                    ...
                    <div class="bg-secondary w-full">
                        ...
                        <div class="account-box" v-if="isAccountViewOpen">
                            <ul>
                                <li>
                                    <button
                                        @click="changeAccountView('memberinfo')"
                                    >
                                        <MemberInfoIcon />
                                    </button>
                                </li>
                                <li>
                                    <button
                                        @click="changeAccountView('setting')"
                                    >
                                        <SettingIcon />
                                    </button>
                                </li>
                                <li>
                                    <button
                                        @click="changeAccountView('dollardoc')"
                                    >
                                        <DollarDocIcon />
                                    </button>
                                </li>
                                <li>
                                    <button
                                        @click="
                                            changeAccountView('announcement')
                                        "
                                    >
                                        <AnnouncementIcon />
                                    </button>
                                ...
                                <li>
                                    <button
                                        @click="changeAccountView('piechart')"
                                    >
                                        <PieChartIcon />
                                    </button>
                                </li>
