  ...
  >
    <template #content>
      <div class="global-search-popup-container">
            ...
            >
              ...
              >
                <path
                  ...
                  d="M415.835,566.937l-2.582-2.515h0l-.061-.092a.61.61,0,0,0-.854,0h0a6.115,6.115,0,0,1-7.9.254,5.729,5.729,0,0,1-1.282-7.6,6.081,6.081,0,0,1,7.571-2.22,5.784,5.784,0,0,1,3.241,7.021.581.581,0,0,0,.137.578.619.619,0,0,0,.581.174.6.6,0,0,0,.446-.4h0a6.974,6.974,0,0,0-3.757-8.417,7.347,7.347,0,0,0-9.111,2.352,6.9,6.9,0,0,0,1.022,9.124,7.379,7.379,0,0,0,9.418.385l2.287,2.227a.617.617,0,0,0,.854,0,.585.585,0,0,0,.009-.83l-.009-.008h0Z"
                  transform="translate(-400.993 -553.013)"
                />
              </svg>
            </div>
            <input
          ...
          >
            ...
            >
              <svg
                ...
                width="10.59"
                height="17.795"
                viewBox="0 0 10.59 17.795"
              >
                <path
                  fill="currentColor"
                  id="arrow_dow_copy"
                  data-name="arrow dow copy"
                  d="M1076.446,558.4a1.457,1.457,0,0,1,1.918-.144l.165.144,6.384,6.548,6.384-6.548a1.458,1.458,0,0,1,1.918-.144l.165.144a1.509,1.509,0,0,1,.143,1.944l-.143.167-7.425,7.6a1.457,1.457,0,0,1-1.918.144l-.165-.144-7.425-7.6A1.509,1.509,0,0,1,1076.446,558.4Z"
                  transform="translate(568.554 -1076.015) rotate(90)"
                />
              </svg>
            </button>
            <span v-if="!openFilters" class="px-[30px]"> Filters </span>
        ...
        <search-list :filter="tblFilter" @row-clicked="clickRow"></search-list>
      </div>
    </template>
  </card>
</template>
