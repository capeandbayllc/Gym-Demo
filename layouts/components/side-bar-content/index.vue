<template>
  <transition name="fade">
    <!--    Initial Sidebar -->
    <div
      class="side-bar-content-container transition-all duration-200 ease-linear overflow-x-hidden"
    >
      <div v-if="!showCheckIn" class="">
        ...
        <div class="mem-checkin-btn" @click="showCheckIn = true">
          Member Check In
        </div>
        ...
        <div class="active-members">
          ...
          <div class="active-member-count text-center">
            <p class="">{{ activeMembers }}</p>
          </div>
        </div>
      ...
      <div v-else>
        <cross-icon
          class="cross-icon collapse-icon h-3"
          @click="showCheckIn = false"
          >X</cross-icon
        >
        <div class="mem-checkin-btn-two" @click="showCheckIn = false">
          Member Check In
        </div>
        ...
        <div class="guest-input">
          <input class="search-input" v-model="form.guestSearch" />
          <div
            class="absolute bottom-0 top-1/3 right-0 flex items-center pr-2 text-gray-400"
          >
