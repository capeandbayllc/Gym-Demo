<template>
  <div class="pulse-club-events">
    <div class="pulse-club-event-list">
      <div v-for="item in mock" :key="item.id" class="pulse-club-event">
        <div class="pulse-club-event-count">
          {{ item.value }}
        </div>
        <div class="pulse-club-event-title">
          {{ item.title }}
        </div>
      </div>
    </div>
